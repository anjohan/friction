...
def handle_step(step):
    infile = f"/home/anders/ssd/creep/lowpress_quartz/water/dump.water_T500_nodrift.{step}.bin"
    outfile = f"/home/anders/ssd/creep/lowpress_quartz/water/dump.water_T500_struc_{step}.xyz"

    with open(infile, "rb") as f:
        atoms = read_lammps_dump_binary(f, colnames=["id", "type", "x", "y", "z", "vx", "vy", "vz"])
    ...
    soapcomps[Ns>1] = np.sum(quartz_soaps[indices]*soaps[Ns>1]/soap_norms[Ns>1], axis=1)
